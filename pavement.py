...
def install_dev_fixtures():
    ...
    fixtures = [
        'sodo/fixtures/initial_data.json',  # user permissions
        'sodo/accounts/fixtures/initial_data.json',  # dummy users and groups
        'sodo/maps/fixtures/initial_data_types.json',  # Maps
        'sodo/core/fixtures/initial_data.json',
        #'sodo/badges/fixtures/initial_data.json', # Removing badges for now, b/c not working
        ]
...
def sync():
    ...
    fixture = 'sodo/fixtures/initial_data.json'
    # sh("python manage.py loaddata {fixture}".format(fixture=fixture))
    _perms_check()
...
def reset_migrations_full():
    ...
    """
    for app in _APPS:
        sh('rm -rf sodo/%s/migrations/' % app)
