...
MEDIA_ROOT = '/opt/src/pyenv/Sodo/nga-Sodo'
...
STATIC_URL_FOLDER = ''  # Can be set to something like 'sodo-test/' if the app is not run at root level
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'sodo.core.contextprocessors.app_settings',
)
...
MIDDLEWARE_CLASSES = (
    ...
    'sodo.core.middleware.UserPermsMiddleware',             # works w/ guardian
    'sodo.core.middleware.Http403Middleware',
    'sodo.core.middleware.UpdateLastActivityMiddleware',
    'sodo.cors.middleware.corsMiddleware'
)
...
LOGIN_REDIRECT_URL = '/accounts/%(username)s/' #'/sodo/'   #
...
os.environ['DJANGO_SETTINGS_MODULE'] = 'sodo.settings'
