...
from views import *
from sodo.maps.views import feature_delete
...
urlpatterns = [
    ...
    url(r'^jobs/metrics/(?P<pk>\d+)/?$',
        ...
        name='job-metrics'),
url(r'^jobs/map-analytics/(?P<pk>\d+)/?$',
        JobDetailedListView.as_view(metrics=True, template_name='core/job_map_analytics.html'),
        name='map-analytics'),
