...
from sodo.core.utils import clean_dumps
...
class GeoKBase(models.Model):
    """
    A generic model for Sodo objects.
    """
...
class Project(GeoKBase):
    """
    Top-level organizational object.
    """

    PROJECT_TYPES = [
        ("Sanitary Pads Collection", "Sanitary Pads Collection"),
        ("Sanitary Pads Distribution","Sanitary Pads Distribution"),
        ("Sex Education", "Sex Education"),
        ("Sanitary Waste Disposal", "Sanitary Waste Disposal"),
...
class Organization(models.Model):
    ...
    show_on_front = models.BooleanField(default=False, help_text="Show on the front of the Sodo App")
