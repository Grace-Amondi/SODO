...
leaflet_helper.constructors.identifyParser = function(result, outputLayer){
    ...
    if (result.results && result.results.length &&
        ...
        parser = leaflet_helper.parsers.sodo_exported_json;
        parserName = "Sodo GeoJSON";
...
leaflet_helper.parsers.sodo_exported_json = function (geojson, map, outputLayer, keepOld) {
    if (outputLayer) {
        if (!keepOld) {
            outputLayer.options.items = [];
            outputLayer.clearLayers();
